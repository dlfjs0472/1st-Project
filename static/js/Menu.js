...
Cafe.menu = {
	Menu : Class({
		...
		isSimpleBoard : function() {
			return this.sMenuType == "E";
		},
		isStaffBoard : function() {
			return this.sMenuType == "8";
		},
		isMemoBoard : function() {
			return this.sMenuType == "M";
		},
		isAttendanceBoard : function() {
			return this.sMenuType == "A";
		},
		isLevelUpBoard : function() {
			return this.sMenuType == "U";
		},
	...
	oNullMenu : {
		...
		isSimpleBoard : function() {return false},
		isMemoBoard : function() {return false},
		isAttendanceBoard : function() {return false},
		isLevelUpBoard : function() {return false},
